			...
			<div class="row" >
				<div class="col-sm-8 col-sm-offset-2 text">
					...
					<div class="description">
						...
						<p style="color:white">Raise your questions, answer your interests</p>
					</div>
				</div>
			</div>
			...
			<div class="row" >
				<div class="col-sm-6 col-md-offset-3 form-box" >
					...
					<div class="form-bottom">
						...
						<div class="btn btn-lg btn-success btn-block" onclick="check()">登录</div>
						<a href=toSignUp style="float:right">注册</a>
						
						<div class="bdsharebuttonbox"><a href="#" class="bds_more" data-cmd="more"></a><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_tqq" data-cmd="tqq" title="分享到腾讯微博"></a><a href="#" class="bds_renren" data-cmd="renren" title="分享到人人网"></a><a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a></div>
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"Staples——你的专属社交问答平台\nRaise your questions, answer your interests","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"18"},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
