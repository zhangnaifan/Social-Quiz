...
<body>
	...
	<fieldset>
		...
		<em>Maybe the hardest part?</em><br /> <em>But we can use some
			really simple way instead :D</em> <br />
		...
		<h3>
			<em>TODO SHOW INVITED QUIZZES/FRIENDS/GROUPS/CHATTERS</em>
		</h3>
		<ol>
	...
	<fieldset>
		...
		<form action="viewAllGroups" method="post">
			<input type="submit" value="View All Groups" />
		</form>
	</fieldset>
