					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<span class="panel-title" style="font-size:20px">
								<a href="groupInfo?groupId=<s:property value='#li.groupId'></s:property>">
									<s:property value='#li.groupName'></s:property>
								</a>
							</span>
							<span style="margin-left: 3%">(<s:property value='#li.groupId'></s:property>)</span>
							<span style="float: right;">
							<span class="panel-title">成员总数:</span>
							<span class="panel-title"><s:property value='#li.totMembers'></s:property></span>
							</span>
						</div>
					</div>
				</s:iterator>
